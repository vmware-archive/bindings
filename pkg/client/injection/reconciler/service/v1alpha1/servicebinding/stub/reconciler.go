...
import (
	...
	servicebinding "github.com/projectriff/bindings/pkg/client/injection/reconciler/service/v1alpha1/servicebinding"
...
func (r *Reconciler) ReconcileKind(ctx context.Context, o *v1alpha1.ServiceBinding) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *v1alpha1.ServiceBinding) reconciler.Event {
//	// TODO: add custom finalization logic here.
//	return nil
//}

// Optionally, use ObserveKind to observe the resource when we are not the leader.
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1alpha1.ServiceBinding) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1alpha1.ServiceBinding) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
