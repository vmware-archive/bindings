...
// controller reconciling v1alpha1.ProvisionedService.
type Interface interface {
	// ReconcileKind implements custom logic to reconcile v1alpha1.ProvisionedService. Any changes
	// to the objects .Status or .Finalizers will be propagated to the stored
	// object. It is recommended that implementors do not call any update calls
	// for the Kind inside of ReconcileKind, it is the responsibility of the calling
	// controller to propagate those properties. The resource passed to ReconcileKind
	// will always have an empty deletion timestamp.
	ReconcileKind(ctx context.Context, o *v1alpha1.ProvisionedService) reconciler.Event
}

// Finalizer defines the strongly typed interfaces to be implemented by a
// controller finalizing v1alpha1.ProvisionedService.
type Finalizer interface {
	// FinalizeKind implements custom logic to finalize v1alpha1.ProvisionedService. Any changes
	...
	// deletion timestamp.
	FinalizeKind(ctx context.Context, o *v1alpha1.ProvisionedService) reconciler.Event
}

// ReadOnlyInterface defines the strongly typed interfaces to be implemented by a
// controller reconciling v1alpha1.ProvisionedService if they want to process resources for which
// they are not the leader.
type ReadOnlyInterface interface {
	// ObserveKind implements logic to observe v1alpha1.ProvisionedService.
	// This method should not write to the API.
	ObserveKind(ctx context.Context, o *v1alpha1.ProvisionedService) reconciler.Event
}

// ReadOnlyFinalizer defines the strongly typed interfaces to be implemented by a
// controller finalizing v1alpha1.ProvisionedService if they want to process tombstoned resources
...
type ReadOnlyFinalizer interface {
	// ObserveFinalizeKind implements custom logic to observe the final state of v1alpha1.ProvisionedService.
	// This method should not write to the API.
	ObserveFinalizeKind(ctx context.Context, o *v1alpha1.ProvisionedService) reconciler.Event
}

// reconcilerImpl implements controller.Reconciler for v1alpha1.ProvisionedService resources.
...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.ProvisionedServices(namespace)
...
func (r *reconcilerImpl) updateStatus(existing *v1alpha1.ProvisionedService, desired *v1alpha1.ProvisionedService) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.ProvisionedService) (*v1alpha1.ProvisionedService, error) {

	getter := r.Lister.ProvisionedServices(resource.Namespace)
...
func (r *reconcilerImpl) setFinalizerIfFinalizer(ctx context.Context, resource *v1alpha1.ProvisionedService) (*v1alpha1.ProvisionedService, error) {
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.ProvisionedService, reconcileEvent reconciler.Event) (*v1alpha1.ProvisionedService, error) {
	if _, ok := r.reconciler.(Finalizer); !ok {
		return resource, nil
	}
	if resource.GetDeletionTimestamp().IsZero() {
