...
import (
	...
	"github.com/projectriff/bindings/pkg/reconciler/servicebindingprep/resources"
	resourcenames "github.com/projectriff/bindings/pkg/reconciler/servicebindingprep/resources/names"
...
func (r *Reconciler) ReconcileKind(ctx context.Context, binding *servicev1alpha1.ServiceBinding) reconciler.Event {
...
func (r *Reconciler) projectedSecret(ctx context.Context, logger *zap.SugaredLogger, binding *servicev1alpha1.ServiceBinding) (*corev1.Secret, error) {
...
func (c *Reconciler) reconcileProtectedSecret(ctx context.Context, binding *servicev1alpha1.ServiceBinding, reference, projection *corev1.Secret) (*corev1.Secret, error) {
