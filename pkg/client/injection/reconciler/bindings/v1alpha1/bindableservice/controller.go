...
import (
	...
	injectionclient "github.com/projectriff/bindings/pkg/client/injection/client"
...
const (
	defaultControllerAgentName = "bindableservice-controller"
	defaultFinalizerName       = "bindableservices.bindings.projectriff.io"
	defaultQueueName           = "bindableservices"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	rec := &reconcilerImpl{
		...
		Lister:     bindableserviceInformer.Lister(),
		Recorder:   recorder,
		reconciler: r,
	}
