...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("springbootcontainers"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Bindings().V1alpha1().SpringBootContainers().Informer()}, nil
